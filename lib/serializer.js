...
function parseResource (type, data, relations, options) {
  ...
  type = utils.caserize(type, options.keyForRelation);
  resource.type = type;
  ...
  _.each(data, function (value, property) {
    if (property === 'id') {
      ...
      property = utils.caserize(property, options.keyForAttribute);
...
function parseRelations (data, relations, options) {
  ...
  _.each(relations, function (relation, name) {
    ...
    name = utils.caserize(name, options.keyForRelation);
