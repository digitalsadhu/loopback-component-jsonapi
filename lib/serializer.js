...
function handleIncludes(resp, includes, relations) {
	if (typeof includes === 'string') {
		handleSingleInclude(resp, includes, relations);
	} else if (_.isArray(includes)) {
		handleMultipleIncludes(resp, includes);
	}
}
...
function handleSingleInclude(resp, include, relations) {
	...
	resp.data.forEach(function (resource) {
		var rel;
		var ids = [];
 ...
 * @return {undefined}
 */
function handleMultipleIncludes(resp, includes) {
