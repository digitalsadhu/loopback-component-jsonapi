...
module.exports = function serializer (type, data, relations, options) {
  ...
  if (options.topLevelLinks) {
	...
	if (options.requestedIncludes) {
		handleIncludes(resultData, options.requestedIncludes);
	}
 ...
 * @return {undefined}
 */
function handleIncludes(resp, includes) {
	if (typeof includes === 'string') {
		handleSingleInclude(resp, includes);
 ...
 * @return {undefined}
 */
function handleSingleInclude(resp, include) {
	var relationships = [];
